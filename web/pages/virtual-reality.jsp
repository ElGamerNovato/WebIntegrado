...
<html lang="en">
    ...
    <head>
        ...
        <link href="/AvanceProject-1/assets/css/textAnimated.css" rel="stylesheet" type="text/css"/>
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">WorkSpace</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">WorkSpace</h6>
                    </nav>
                        ...
                        <div class="row pt-10">
                            <div class="col-lg-1 col-md-1 pt-5 pt-lg-0 ms-lg-5 text-center">
                                <a href="javascript:;" class="avatar avatar-md border-0" data-bs-toggle="tooltip" data-bs-placement="left" title="My Profile">
                                    <img class="border-radius-lg" alt="Image placeholder" src="/AvanceProject-1/assets/img/bruce-mars.jpg">
                                </a>
                            ...
                            <div class="col-lg-8 col-md-11">
                                <div class="d-flex">
                                    <div class="me-auto">
                                        <h1 class="display-1 font-weight-bold mt-n4 mb-0" id="animated-text" >Bienvenido <%= nameAdmin %></h1>
                                    </div>
                                    <div class="ms-auto">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                for (let i = 0; i < textLength; i++) {
                    ...
                    }, i * 300); // Cambia el valor de 300 para ajustar la velocidad de animación
                }
            });
