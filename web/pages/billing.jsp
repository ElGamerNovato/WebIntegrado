        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
            ...
            <div >
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active" href="/AvanceProject-1/pages/billing.jsp">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="card-body position-relative z-index-1 p-3">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                                                    <img class="w-60 mt-2" src="/AvanceProject-1/assets/img/logos/mastercard.png" alt="logo">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-md-0 mb-4">
                                                <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                                                    <img class="w-10 me-3 mb-0" src="/AvanceProject-1/assets/img/logos/mastercard.png" alt="logo">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                                                    <img class="w-10 me-3 mb-0" src="/AvanceProject-1/assets/img/logos/visa.png" alt="logo">
